...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('tbl_fornecedores', function (Blueprint $table) {
            ...
            $table->string('email_fornecedor', 80);
            $table->string('telefone_fornecedor', 14)->unique('telefone_fornecedor');
            $table->string('status_fornecedor', 10)->default('ATIVO');
            $table->dateTime('criado_em_fornecedor')->useCurrent();
            $table->dateTime('atualizado_em_fonecedor')->useCurrentOnUpdate()->useCurrent();
        });
    }
