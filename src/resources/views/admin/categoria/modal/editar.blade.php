<div class="modal modal-lg fade" id="editar{{$categoria->id_categoria}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            ...
            <div class="modal-body">
                ...
                <form method="POST" action="{{ route('admin.categoria.update',   $categoria->id_categoria ) }}">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="nome_categoria" value="{{$categoria->nome_categoria}}" aria-describedby="emailHelp"
                    ...
                    <div class="mb-3">
                        ...
                        <textarea type="textarea" class="form-control" id="descricao_categoria"   rows="3" required
                            name="descricao_categoria" >{{$categoria->descricao_categoria}}</textarea>
                    ...
                    <div class="mb-3 row align-items-center">
                        <div class="col-6">
                            ...
                            <input class="form-control  form-control" id="ordem_categoria" type="number"
                                name="ordem_categoria" value="{{$categoria->ordem_categoria}}">
