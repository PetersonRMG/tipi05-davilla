  <!--begin::Header-->
  <nav class="app-header navbar navbar-expand bg-primary-subtle shadow navbar-primary navbar-dark border-start border-white" data-bs-theme="dark">
    <!--begin::Container-->
      ...
      <ul class="navbar-nav ms-auto">
        ...
        <!--begin::User Menu Dropdown-->
          ...
          @php
            ...
            : asset('dash/assets/img/user/default.jpg');
        ...
        <li class="nav-item dropdown user-menu">
          ...
          <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-end">
            ...
            <li class="user-header text-bg-primary">
              ...
              />
              <p>
                {{ $usuarioLogado->nome_usuario }} - {{ $usuarioLogado->perfil_usuario }}
                <small>Funcionario desde: {{ date('d/m/y', strtotime($usuarioLogado->criado_em_usuario)) }}</small>
              </p>
            </li>
            <!--end::User Image-->
            <!--begin::Menu Body-->
            ...
            <li class="user-footer">
              <a href="{{ route('admin.perfil') }}" class="btn btn-outline-secondary">Perfil</a>
