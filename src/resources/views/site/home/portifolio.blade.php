    ...
    <section class="portfolio-section">
        <div class="auto-container">
            ...
            <div class="row">
                @foreach ($listaProduto as $item)
                <!-- Portfolio Block -->
                <div class="portfolio-block col-lg-3 col-md-6 col-sm-12">
                    <div class="inner-box">
                         <div class="image-box"><figure class="image"><img src="{{asset('davilla/images/'.$item->foto_produto)}}" alt="{{$item->slug_produto}}"></figure></div> 
                        <div class="portfolio-hover">
                            ...
                            <h3><a href="{{route('cardapio.produto', $item->slug_produto)}}">{{$item->nome_produto}}</a></h3>
                        </div>
                    </div>
                </div>
