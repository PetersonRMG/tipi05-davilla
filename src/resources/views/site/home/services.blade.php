    ...
    <section class="services-section" style="background-image: url();">
        <div class="auto-container">
            ...
            <div class="services-carousel owl-carousel owl-theme">
                <!-- Service Block -->
                @foreach ($filtroCategoria as $data)
                <div class="service-block">
                    <a href="{{route('cardapio.categoria', $data->id_categoria)}}">
                        <div class="inner-box">
                            <div class="image-box">
                                ...
                                <!-- cake img -->
                                 <figure class="image"><img src="{{asset("davilla/images/cup-cake-$data->id_categoria.svg")}}" alt=""></figure>
                            </div>
                            <h3>{{$data->nome_categoria}}</h3>
