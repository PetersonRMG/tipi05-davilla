...
<section class="testimonial-section">
    <div class="shape_wrapper shape_one">
        ...
        <div class="shape_inner shape_two" >
                    @php
        $testimonial = asset('davilla/images/backgrounds/pink-cupcakes-donuts-with-hearts-pink-background.webp')
        @endphp
            <div class="overlay" style="background-image: url('{{$testimonial}}'); background-size: cover"></div>
        </div>
    </div>
            ...
            <div class="testimonial-block">
                <div class="inner-box">
                    <div class="testimonial_img">
                        ...
                        <!-- Thumb Box -->
                         <figure class="thumb-box"><div class="logo76"><img src="{{asset('davilla/images/cup-cake-1.svg')}}" alt="" ></div></figure> 
            ...
            <div class="testimonial-block">
                <div class="inner-box">
                    <div class="testimonial_img">
                        ...
                        <!-- Thumb Box -->
                          <figure class="thumb-box"><div class="logo76"><img src="{{asset('davilla/images/cup-cake-2.svg')}}" alt="" ></div></figure> 
            ...
            <div class="testimonial-block">
                <div class="inner-box">
                    <div class="testimonial_img">
                        ...
                        <!-- Thumb Box -->
                         <figure class="thumb-box"><div class="logo76"><img src="{{asset('davilla/images/footer-logo.png')}}" alt="" ></div></figure> 
