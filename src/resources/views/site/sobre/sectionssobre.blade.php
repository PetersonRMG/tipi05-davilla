        @php
            $bgabout1 = asset('davilla/images/backgrounds/imgsobre-3.jpg');
            $bgabout2 = asset('davilla/images/backgrounds/imgsobre-1.jpg');
            $bgabout3 = asset('davilla/images/backgrounds/imgsobre-5.jpg');
            $bgabout4 = asset('davilla/images/backgrounds/imgsobre-6.jpg');
            $bgabout5 = asset('davilla/images/backgrounds/imgsobre-2.jpg');
         @endphp       
       <!--Page Title-->
    <section class="page-title" style="background-image: url('{{$bgabout1}}')">
    ...
    <section class="about-section-two alternate" style="background-image: url('{{$bgabout2}}');">
        <div class="auto-container">
    ...
    <div class="features-section style-two">
        <div class="shape_wrapper shape_one">
            <div class="shape_inner shape_two" style="background-image: url('{{$bgabout3}}');"><div class="overlay"></div></div>
        </div>
    ...
    <!-- Chef Section -->
    <section class="chef-section" style="background-image: url('{{$bgabout5}}');">
        <div class="auto-container">
            <div class="row">
                ...
                <div class="image-column col-lg-6 col-md-12 col-sm-12">
                    <div class="inner-column">
                        <figure class="image"><img src="{{asset('davilla/images/backgrounds/chef.png')}}" alt=""></figure>
                    </div>
                </div>
            </div>
        </div>
